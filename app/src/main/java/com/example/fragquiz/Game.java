...
public class Game {
    ...
    private Question question48 = new Question("En amerikansk stat har udråbt gærtypen Saccharomyces cerevisiae som statens national mikroorganisme, pga. gærets betydning for statens bryggerier. Hvilken stat er der tale om?", "Oregon","Wisconsin","Wyoming","North Dakota", 1, 5);
    ...
    private Question question60 = new Question("Et bryghus har omdannet de gamle ølkar til pools fyldt med øl, så gæster kan nyde en dukkert i den gyldne drik, der samtidigt skulle være godt for huden. I hvilket land ligger dette bryghus?", "Spanien","Holland","USA","Østrig", 4, 4);
    ...
    private Question question63 = new Question("Forkning inden for øl har ført til bedre behandlig af sygdomme. Hvilken sygdoms behandlig er blevet forbedret på grund af forskning omkring øl?","Gigt","Diabetes","Kræft","Knogleskørhed", 2, 1);
